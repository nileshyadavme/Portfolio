...
export function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col relative selection:bg-[var(--color-gold)] selection:text-[var(--color-text)]">
      ...
      <ThemeToggle />
      {/* 
        Suspense wraps AnimatePresence here — NOT inside it.
        This way the spinner shows BEFORE the page transition begins,
        so AnimatePresence always animates into a fully-loaded page.
      */}
      <Suspense
        fallback={
          <main className="flex-grow max-w-4xl w-full mx-auto px-6 pt-24 pb-24 flex items-center justify-center">
